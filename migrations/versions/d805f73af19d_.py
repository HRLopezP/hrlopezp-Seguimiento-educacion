...
Revision ID: d805f73af19d
Revises: 
Create Date: 2026-03-05 02:16:17.810461
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('PLANIFICADO', 'EN_PROGRESO', 'COMPLETADO', 'SUSPENDIDO', name='projectstatus'), nullable=False),
