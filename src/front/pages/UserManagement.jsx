    ...
    return (
        <div className="management-container">
            ...
            <div className="management-header">
                <h2 className="text-oxford">Gestión de Usuarios</h2>
                <p>Administra los accesos y roles del personal de SIGSSEP</p>
            </div>

            <div className="table-responsive management-card">
                                ...
                                <tr key={user.id_user || index}>
                                    ...
                                    <td className="text-center">
                                        <button
                                            ...
                                            /* Probamos con id_user, que es el estándar de tu proyecto SIGSSEP */
